...
#SBATCH --mem=64G
#SBATCH --job-name=moirai2_gba2018
#SBATCH --account=bcqc-delta-gpu
#SBATCH --partition=gpuA100x4
#SBATCH --output=/u/tliao2/TrafficFM/log/fm/%j_run_moirai2_gba_2018.out
#SBATCH --error=/u/tliao2/TrafficFM/log/fm/%j_run_moirai2_gba_2018.err
