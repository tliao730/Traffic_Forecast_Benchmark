...
#SBATCH --mem=64G
#SBATCH --job-name=sundial_sd2019
#SBATCH --account=bcqc-delta-gpu
#SBATCH --partition=gpuA40x4
#SBATCH --output=/u/tliao2/TrafficFM/log/fm/%j_run_sundial_sd_2019.out
#SBATCH --error=/u/tliao2/TrafficFM/log/fm/%j_run_sundial_sd_2019.err
