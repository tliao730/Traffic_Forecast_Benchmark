...
#SBATCH --mem=64G
#SBATCH --job-name=m2_l1_s256
#SBATCH --account=bcqc-delta-gpu
#SBATCH --partition=gpuA40x4
#SBATCH --output=log/fm/%j_run_moirai2_l1_sd_2019_s256.out
#SBATCH --error=log/fm/%j_run_moirai2_l1_sd_2019_s256.err

cd /u/tliao2/TrafficFM/benchmark

BENCHMARK_CONFIG=configs/sd_2019_finetune.yaml \
WANDB_PROJECT="TrafficFM" \
MOIRAI2_MODEL_NAME="Moirai2-L1-SD2019-S256" \
