...
#SBATCH --output=/u/tliao2/TrafficFM/log/fm/%j_run_timesfm_sd_2018.out
#SBATCH --error=/u/tliao2/TrafficFM/log/fm/%j_run_timesfm_sd_2018.err

cd /u/tliao2/TrafficFM/benchmark

BENCHMARK_CONFIG=configs/fm_sd_2018.yaml \
HF_HOME=/u/tliao2/.cache/huggingface/hub \
