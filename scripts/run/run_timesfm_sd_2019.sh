...
#SBATCH --mem=64G
#SBATCH --job-name=timesfm_sd2019
#SBATCH --account=bcqc-delta-gpu
#SBATCH --partition=gpuA100x8
#SBATCH --output=/u/tliao2/TrafficFM/log/fm/%j_run_timesfm_sd_2019.out
#SBATCH --error=/u/tliao2/TrafficFM/log/fm/%j_run_timesfm_sd_2019.err
