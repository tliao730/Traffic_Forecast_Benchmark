...
#SBATCH --mem=64G
#SBATCH --job-name=kairos_sd2018
#SBATCH --account=bcqc-delta-gpu
#SBATCH --partition=gpuA100x4
#SBATCH --output=/u/tliao2/TrafficFM/log/fm/%j_run_kairos_sd_2018.out
#SBATCH --error=/u/tliao2/TrafficFM/log/fm/%j_run_kairos_sd_2018.err
