...
#SBATCH --mem=64G
#SBATCH --job-name=kairos_gba2018
#SBATCH --account=bcqc-delta-gpu
#SBATCH --partition=gpuA40x4
#SBATCH --output=/u/tliao2/TrafficFM/log/fm/%j_run_kairos_gba_2018.out
#SBATCH --error=/u/tliao2/TrafficFM/log/fm/%j_run_kairos_gba_2018.err
