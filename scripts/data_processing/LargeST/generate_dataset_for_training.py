...
TARGET_DIR = Path("dataset/LargeST/baseline")
...
def generate_train_val_test(args):
    ...
    df = pd.DataFrame()
    for y in years:
        h5_path = Path("data/LargeST") / args.dataset / f"{args.dataset}_his_{y}.h5"
        df_tmp = pd.read_hdf(h5_path)
    ...
    # save
    out_dir = TARGET_DIR / args.dataset / args.years
