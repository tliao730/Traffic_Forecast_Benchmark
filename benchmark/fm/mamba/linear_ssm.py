"""
LinearSSM (base model) for traffic forecasting using gift_eval data format.
...
Run from benchmark/:
  uv run --project fm/moirai python fm/mamba/linear_ssm.py --year 2018
"""
...
def get_args():
    ...
    parser.add_argument("--log_dir",             type=str,
                        default="/scratch/bcqc/tliao2/TrafficFM/experiments/ssm_bench/linear_ssm/SD/2019/")
...
def main():
    ...
    model_name = f"linear_ssm_{args.dataset.upper()}{args.year}_ctx{args.context_length}_w{args.windows_per_sensor}"
    wandb.init(
    ...
    predictor = LinearSSMPredictor(checkpoints=checkpoints, args=args, device=device)
